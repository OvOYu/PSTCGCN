...
from model.PSTCGCN import PSTCGCN as Network
...
Mode = 'train'
DEBUG = 'False'
DATASET = 'PEMSD3'      #PEMSD4 or PEMSD7
DEVICE = 'cuda:0'
MODEL = 'PSTCGCN'
...
args.add_argument('--num_channels', default=config['model']['num_channels'], type=eval)
args.add_argument('--gat_hiden', default=config['model']['gat_hiden'], type=int)
...
args.add_argument('--at_filter', default=config['train']['at_filter'], type=int)
...
if torch.cuda.is_available():
    ...
    args.device = 'cpu'
# {80,160,200}
adj, _ = get_adjacency_matrix(args.graph_path, args.num_nodes,'./data/PEMS03/PEMS03.txt', direction=1)
