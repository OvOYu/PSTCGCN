...
from lib.add_window import Add_Window_Horizon, Add_Window_Horizon_3channel
from lib.load_dataset import load_st_dataset
from lib.normalization import (ColumnMinMaxScaler, MinMax01Scaler,
                               MinMax11Scaler, NScaler, StandardScaler)
...
def get_dataloader(args, normalizer = 'std', tod=False, dow=False, weather=False, single=True):
    ...
    x_tra, y_tra = Add_Window_Horizon_3channel(data_train, args.lag, args.horizon, single)
    x_val, y_val = Add_Window_Horizon_3channel(data_val, args.lag, args.horizon, single) 
    x_test, y_test = Add_Window_Horizon_3channel(data_test, args.lag, args.horizon, single)
    #normalize st data
